...
CTA_ABOUT_CTA_MESSAGE			= "The \'CallToArms\' LFG mod makes it very easy to form groups in WoW, this version is based off the original version which was not updated for TBC. It is currently being tested so it can be released."
...
["ZULAMAN"] = { "za" },
["MAGISTERSTERRACE"] = { "mgt", "mst", "mrt", "mt", "qd5" },
["SUNWELLPLATEAU"] = { "sp" },
["GRUULSLAIR"] = { "gruul?", "gl" },
["MAGTHERIDONSLAIR"] = { "mag?", "ml" },
["SERPENTSHRINECAVERN"] = { "ssc", "vas?" },
["THEEYE"] = { "tk", "eye" },
["BLACKTEMPLE"] = { "bt" },
	},
